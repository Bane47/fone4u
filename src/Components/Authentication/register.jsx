    ...
    const registerValidate = (e) => {
       e.preventDefault();
        if (name === "") {
            ...
            alert("The password should contain atleast one uppercase one lowercase one number and one special character and the minimum length of the password is 8 and maximum is 16");
        }

        else if (!phoneRegEx.test(phone)) {
            alert("Please enter a valid PHONE id");
        }
                    ...
                    <Form.Group id="exampleForm.ControlInput1">
                        <div className='row'>
                            ...
                            <div className="col-lg-5 col-md-5 col-sm-5 m-2">
                                <Form.Control size="md" type="text" placeholder="Name" value={name} onChange={(e) => { setName(e.target.value) }} />
                            </div>
                        </div>
                    </Form.Group>
                    <Form.Group id="exampleForm.ControlInput1">
